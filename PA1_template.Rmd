...
Mean from first part is `r step_mean`, and mean from this part is `r step_mean_no_NA`  
Median from first part is `r step_median`, and median from this part is `r step_median_no_NA`  
